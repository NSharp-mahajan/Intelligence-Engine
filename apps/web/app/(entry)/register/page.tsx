      ...
      <div style={styles.rightPanel}>
        <div style={styles.formContainer}>
          <div style={styles.formHeader}>
            <h2 style={styles.title}>Create your Career Intelligence profile</h2>
            <p style={styles.subtitle}>Your account will be used to build your evidence-based career profile.</p>
          </div>
